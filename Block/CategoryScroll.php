...
class CategoryScroll extends Template
{
    public const MODULE_ENABLE = 'riverstone_scroll/general/enable';
    public const LOADER_TYPE = 'riverstone_scroll/general/catalog_loader_type';
    public const END_PAGE_TEXT = 'riverstone_scroll/general/catalog_end_page_text';
    public const NO_OF_TILES = 'riverstone_scroll/general/catalog_no_of_tiles';
    public const DISPLAY_BACK_BUTTON = 'riverstone_scroll/general/catalog_display_back_button';
    public const LOADER_BUTTON_TEXT = 'riverstone_scroll/general/catalog_loader_button_text';
    public const LOADER_BUTTON_COLOR = 'riverstone_scroll/general/catalog_loader_button_color';
    public const TOP_BUTTON_TEXT = 'riverstone_scroll/general/catalog_back_text';
    public const TOP_BUTTON_COLOR = 'riverstone_scroll/general/catalog_back_button_color';
